...
Config.ParkingButton              = 168          -- 👉 F5 (vehicle exit and or park)
...
Config.UseOnlyPreCreatedParkSpots = false         -- 👉 True If players can only park on pre-created locations, if false ot true player are not able to park on pre-created park lots
Config.UseOnlyForVipPlayers       = false        -- 👉 If you want to use it for vip players only
Config.UseParkedLocationNames     = false         -- 👉 If you want to see markers
